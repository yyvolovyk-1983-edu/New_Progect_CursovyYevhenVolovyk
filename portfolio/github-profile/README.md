...
Студент **ХНУА «ХАІ»** (Харківський Національний Аерокосмічний Університет), що спеціалізується на перетині **AI-автоматизації** та **мережевої безпеки**.
...
- Провів повний security-аудит домашньої мережі з D → B+ за 2 дні (27 знахідок, всі закриті)
