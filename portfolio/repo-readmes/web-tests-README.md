...
| Репо | Тема |
|------|------|
| `avtomaticwebtests1.1` | Базові Selenium тести, локатори елементів |
| `avtamaticWebTestLaba2.2` | PageObject паттерн, тест-сюіти |
| `avtomaticwebtests1.3` | Java Collections — аналіз HashSet/equals/hashCode |
